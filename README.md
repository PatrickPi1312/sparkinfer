...
|---:|---:|---:|---:|---:|
| 4k | **134.0** tok/s | 90.4 tok/s | **1.483×** | 1.882 |
...
<sub>Auto-refreshed by the DSpark eval bot at `0d9fefc28` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
