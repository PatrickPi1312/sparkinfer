...
|---:|---:|---:|---:|---:|
| 4k | **120.3** tok/s | 90.4 tok/s | **1.331×** | 1.730 |
...
<sub>Auto-refreshed by the DSpark eval bot at `de248d423` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
