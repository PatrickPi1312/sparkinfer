...
|---:|---:|---:|---:|---:|
| 4k | **140.9** tok/s | 90.7 tok/s | **1.553×** | 1.910 |
...
<sub>Auto-refreshed by the DSpark eval bot at `b30d638c6` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
