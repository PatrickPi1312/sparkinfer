...
|---:|---:|---:|---:|---:|
| 4k | **114.7** tok/s | 90.3 tok/s | **1.270×** | 1.662 |
...
<sub>Auto-refreshed by the DSpark eval bot at `ae5a2053d` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
