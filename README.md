...
|---:|---:|---:|---:|---:|
| 4k | **128.8** tok/s | 90.4 tok/s | **1.426×** | 1.882 |
...
<sub>Auto-refreshed by the DSpark eval bot at `d3c712e29` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
