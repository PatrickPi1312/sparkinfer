...
|---:|---:|---:|---:|---:|
| 4k | **109.7** tok/s | 88.4 tok/s | **1.241×** | 1.806 |
...
<sub>Auto-refreshed by the DSpark eval bot at `9ffaef612` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
